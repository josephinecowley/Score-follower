...
# Single note
wav_file = '/Users/josephine/Documents/Engineering /Part IIB/Score alignment project/Score-follower/wav_files/piano_C5_523.wav'
sample_rate, data = wav.read(wav_file)
helper.plot_fft(data, sample_rate)
helper.return_kernel_spectrum(f=[523], M=13, scalar=200, no_samples=len(data))
