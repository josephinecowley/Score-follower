...
# Truncate data to 2000 samples long
data3 = data3[4000:6000]
data3 = np.array(data3)


# Import 4 different beethoven chords
diminished = [196, 233, 277, 330]
...
for i in range(8):
    sample_data.append(
        data[int(onset_time_samples[i] + 3000):int(onset_time_samples[i])+5000])
...
for i in sample_data:
    nlml = np.append(nlml, (helper.stable_nlml(
        time_samples, i, f=beethoven_freqs[0], M=10, sigma_f=2.72,  amplitude=2.05)))
